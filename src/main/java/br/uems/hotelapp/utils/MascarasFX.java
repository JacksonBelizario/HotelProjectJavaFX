...
public class MascarasFX {
    ...
    public static void mascaraTelefone(TextField textField) {
        ...
        textField.setOnKeyTyped((KeyEvent event) -> {
            ...
            int charLength = textField.getText().length();
            String text = textField.getText();

            if (event.getCharacter().trim().length() == 0) { // apagando

                if (charLength == 10 && text.substring(9, 10).equals("-")) {
                    textField.setText(text.substring(0, 9));
                    textField.positionCaret(charLength);
                }
                if (charLength == 9 && text.substring(8, 9).equals("-")) {
                ...
                if (charLength == 3) {
                    textField.setText(text + ")" + event.getCharacter());
                    textField.positionCaret(charLength);
                    event.consume();
                }
                if (charLength == 8) {
                ...
                if (charLength == 9 && text.substring(8, 9) != "-") {
                    textField.setText(text + "-" + event.getCharacter());
                    textField.positionCaret(charLength);
                    event.consume();
                }
                if (charLength == 13 && text.substring(8, 9).equals("-")) {
                    textField.setText(text.substring(0, 8) + text.substring(9, 10) + "-" + text.substring(10, 13) + event.getCharacter());
                    textField.positionCaret(charLength);
                    event.consume();
                }
